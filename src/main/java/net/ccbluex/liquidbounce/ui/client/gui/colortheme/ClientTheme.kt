...
object ClientTheme {
    ...
    fun setColor(type: String, alpha: Int, customColor: Boolean = true): Color {
        ...
        val color = when (mode) {
            ...
            "${CrossSine.CLIENT_NAME.toLowerCase()}" -> if (type == "START") Color(85, 255, 255, alpha) else Color(85, 255, 140, alpha)
    ...
    fun getColor(index: Int = 0, customColor: Boolean = true): Color {
        ...
        val colorMap = mapOf(
            ...
            "${CrossSine.CLIENT_NAME.toLowerCase()}" to Pair(Color(85, 255, 140), Color(85, 255, 255)),
    ...
    fun getColorFromName(name: String, index: Int, alpha: Int,  customColor: Boolean = true): Color {
        ...
        val colorMap = mapOf<String, (Double) -> Color>(
            ...
            "${CrossSine.CLIENT_NAME.toLowerCase()}" to { fadeSpeed -> ColorUtils.mixColors(Color(85, 255, 140), Color(85, 255, 255), fadeSpeed, index).setAlpha(alpha) },
    ...
    fun getColorWithAlpha(index: Int, alpha: Int, customColor: Boolean = true): Color {
        ...
        return when (ClientColorMode.get().lowercase()) {
            ...
            "${CrossSine.CLIENT_NAME.toLowerCase()}" -> ColorUtils.mixColors(Color(85, 255, 180), Color(85, 255, 255), fadeSpeed, index).setAlpha(alpha)
