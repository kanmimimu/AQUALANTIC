package net.ccbluex.liquidbounce.ui.client.gui.clickgui.style.styles.astolfo
...
class AstolfoClickGui : GuiScreen() {
  ...
  private val scale: Float
    get() = CrossSine.moduleManager.getModule(ClickGUIModule::class.java)?.scaleValue?.get()!!
  private val scroll: Float
    get() = CrossSine.moduleManager.getModule(ClickGUIModule::class.java)?.scroll?.get()!!
