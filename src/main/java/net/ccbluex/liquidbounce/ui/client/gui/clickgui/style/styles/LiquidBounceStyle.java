            ...
            if(moduleElement.isShowSettings()) {
                ...
                for(final Value value : moduleValues) {
                    ...
                    if (value instanceof BoolValue) {
                        ...
                        RenderUtils.drawRect(moduleElement.getX() + moduleElement.getWidth() + 4, yPos + 2, moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth(), yPos + 19, Integer.MIN_VALUE);
                        GlStateManager.resetColor();
                        Fonts.Nunito40.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, 0xffffff);
                        yPos += 17;
                    }
                }
