...
object CrossSine {
    // Client information
    const val CLIENT_NAME = "AQUALANTIC"
    ...
    const val COLORED_NAME = "§fA§bQ§fUA§bLANTIC§r"
    const val CLIENT_CREATOR = "hmm-kanmimimu"
    ...
    fun initClient() {
        ...
        Display.setTitle("$CLIENT_NAME B$CLIENT_VERSION AQUALANTIC.com")
